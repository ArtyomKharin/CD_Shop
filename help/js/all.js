...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["Information system for CD shop","How to see statistics","How to add record to table","How to edit record","How to delete record (administrator mode)"],
	DREX_NODE_LINKS: ["information_system_for_cd_shop.htm","how_to_see_statistics.htm","how_to_add_record_to_table.htm","how_to_edit_record.htm","how_to_delete_record__administrator_mode_.htm"],
...
DR_EXPLAIN.data_search = {
	...
	DREXPLAIN_EMPTY_STRING: "Enter text for search",
